...
<div class="min-h-screen bg-background dark:bg-[#101013] flex">
    <div class="flex-1 mr-1/4">
        <header class="p-4 shadow-lg dark:shadow-none">
            <AppBar avatarUrl={data.avatarUrl} fallbackAvatar={data.fallbackAvatar} />
        </header>
        <div class="flex">
            <main class="flex-1 flex flex-col items-center justify-center py-16 text-gray-[#101013] dark:text-white">
                <h1 class="text-5xl font-bold mb-6">Welcome to Typewriter</h1>
                <p class="text-xl mb-12 text-center max-w-3xl">
                ...
                <section id="ProductsSection" class="flex flex-col space-y-5 sm:flex-row sm:space-y-0 sm:space-x-5">
